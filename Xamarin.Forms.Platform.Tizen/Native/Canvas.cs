...
namespace Xamarin.Forms.Platform.Tizen.Native
{
#if __MATERIAL__
	/// <summary>
	/// A MaterialCanvas provides a class which can be a container for other controls.
	/// </summary>
	/// <remarks>
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="Xamarin.Forms.Platform.Tizen.Native.MaterialCanvas"/> class.
		/// </summary>
